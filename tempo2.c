...
// Data da última modificação: 27 de novembro de 2020
// Descrição resumida: Segunda tarefa de simulação da disciplina Sistemas Distribuídos.
...
int main(int argc, char* argv[]) {
	...
	if(argc!=2) {
		puts("Uso correto: tempo2 <número de processos>");
		exit(1);
	}
